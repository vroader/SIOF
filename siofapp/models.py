...
class TblFcdfempenho(models.Model):
    ...
    emf_numeroprocesso = models.CharField(db_column='emf_NumeroProcesso', max_length=24, blank=True, null=True)  # Field name made lowercase.
    ...
    emf_programatrabalhoresumido = models.CharField(db_column='emf_ProgramaTrabalhoResumido', max_length=17, blank=True, null=True)  # Field name made lowercase.
...
class TblFcdfitemempenho(models.Model):
    ...
    itf_itemaquisicaoservico = models.ForeignKey('TblItemaquisicaoservico', models.DO_NOTHING, db_column='itf_ItemAquisicaoServico')  # Field name made lowercase.
    itf_empenho = models.ForeignKey(TblFcdfempenho, models.DO_NOTHING, db_column='itf_Empenho')  # Field name made lowercase.
    itf_codigoitem = models.IntegerField(db_column='itf_CodigoItem', blank=True, null=True)  # Field name made lowercase.
...
class TblGdfquadrodetalhamentodespesa(models.Model):
    ...
    qdg_programatrabalho = models.CharField(db_column='qdg_ProgramaTrabalho', max_length=21, blank=True, null=True)  # Field name made lowercase.
